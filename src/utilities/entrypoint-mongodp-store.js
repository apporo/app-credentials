...
function EntrypointMongodpStore(params) {
  params = params || {};

  let {L, T, fieldNameRef, entrypointStoreMongodp: storeCfg, mongoManipulator} = params;
...
module.exports = EntrypointMongodpStore;
